...
export async function runCiProbe() {
  ...
  try {
    ...
    const required = [
      ...
      "host-extended-editing",
      "native-extended-editing",
      "host-ex-editing-and-addresses",
      "host-ex-rejection-and-confirmation",
      "host-ex-confirmation-replay-order",
      "native-ex-editing-and-addresses",
      "native-ex-rejection-and-confirmation",
      "native-ex-confirmation-replay-order",
      "host-local-marks-and-edit-tracking",
      "host-counted-local-jumps",
      "host-local-navigation-isolation-and-reset",
      "native-local-marks-and-cell-recreation",
      "native-mark-edit-tracking",
      "native-offscreen-mark-restoration",
      "native-navigation-replay-order",
      "host-split-panes",
